...
def _build_result_dict(
    ...
    return {
        ...
        "zernike_polynomial_basis": learning_result.zernikeContext.zernike_polynomial_basis,
        "zernike_magnitude_indeices": learning_result.zernikeContext.zernike_polynomial_basis,
        "zernike_phase_indices": learning_result.zernikeContext.zernike_polynomial_basis,
